...
//	private Animation animation;
	...
	public Menu(GameStateManager gsm) {
		...
		/*
		 * int allPoints2 = BouncingBilly.prefsPoints.getInteger("1_lvlPoints"); BouncingBilly.prefsPoints.putInteger("allPoints", allPoints2); BouncingBilly.prefsPoints.flush();
		 */
		...
		/*
		 * tex = BouncingBilly.res.getTexture("billy"); TextureRegion[] reg = new TextureRegion[4]; for(int i = 0; i < reg.length; i++) { reg[i] = new TextureRegion(tex, i * 32, 0, 32, 32); }
		 * 
	...
	public void render() {
		...
		/*
		 * // draw title for(int i = 0; i < blocks.size; i++) { blocks.get(i).render(sb); }
		 */
	}
